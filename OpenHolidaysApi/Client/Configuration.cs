...
public class Configuration : IReadableConfiguration
{
    ...
    public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
    {
        ...
        {
            >= 400 => new ApiException(status, $"Error calling {methodName}: {response.Content}", response.Content),
            0 => new ApiException(status, $"Error calling {methodName}: {response.ErrorMessage}",
    ...
    public Configuration()
    {
        ...
        BasePath = "https://openholidaysapi.org/";
    ...
    /// </summary>
    public virtual ApiClient ApiClient => _apiClient ??= CreateApiClient();
    ...
    public virtual int Timeout
    {
        get
        {
            if (_apiClient == null) return _timeout;

            return (int)ApiClient.RestClient.Options.Timeout.GetValueOrDefault(TimeSpan.FromSeconds(100))
                .TotalMilliseconds;
        }
        set
        {
