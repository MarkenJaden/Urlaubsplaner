...
/// </summary>
[DataContract]
public class ProblemDetails : Dictionary<string, object>, IEquatable<ProblemDetails>, IValidatableObject
{
    /// <summary>
    ...
    {
        return input != null && base.Equals(input);
    }
    ...
    {
        return Equals(input as ProblemDetails);
    }
